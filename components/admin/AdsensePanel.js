    ...
    <div>
      <div style={S.card}>
        ...
        <div style={{ marginBottom: 20, padding: 16, background: '#fffbeb', border: '1.5px solid #fcd34d', borderRadius: 12, fontSize: 13, color: '#92400e', lineHeight: 1.7 }}>
          ...
          2. 생성된 <code style={{ background: '#fef3c7', padding: '2px 6px', borderRadius: 4, color: '#92400e' }}>&lt;script&gt;</code> 코드를 해당 슬롯에 붙여넣습니다.<br />
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
                  <div style={{ flex: 1, minWidth: 220 }}>
                    ...
                    <div style={{
                      ...
                      background: activeVal && slot.code ? '#f0fdf4' : activeVal ? '#fffbeb' : '#f5f5f5',
                      border: `1.5px dashed ${activeVal && slot.code ? '#22c55e' : activeVal ? '#fbbf24' : '#d1d5db'}`,
                      borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center',
                      fontSize: 12, color: activeVal && slot.code ? '#16a34a' : activeVal ? '#92400e' : '#9ca3af', marginBottom: 10,
                    }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                    ...
                    <span style={{ fontSize: 11, color: activeVal && slot.code ? '#16a34a' : activeVal ? '#92400e' : '#6b7280', fontWeight: 600 }}>
