...
export const CATEGORIES = [
  { id: 'fish',     label: '수산물',    emoji: '🐟', color: '#0ea5e9' },
  { id: 'veg',      label: '채소·나물', emoji: '🥬', color: '#22c55e' },
  { id: 'fruit',    label: '과일',      emoji: '🍎', color: '#f97316' },
  { id: 'grain',    label: '곡물·가공', emoji: '🌾', color: '#eab308' },
  { id: 'meat',     label: '육류',      emoji: '🥩', color: '#ef4444' },
  { id: 'mushroom', label: '버섯·산채', emoji: '🍄', color: '#a855f7' },
]
