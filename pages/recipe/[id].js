    ...
    <>
      ...
      {modalName && (
        <div onClick={closeModal}
          style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, padding: 20 }}>
          <div onClick={e => e.stopPropagation()} className="detail-box"
            style={{ maxWidth: 420, width: '100%', maxHeight: '85vh', padding: '22px 24px', position: 'relative', display: 'flex', flexDirection: 'column' }}>
            ...
            <h3 style={{ fontSize: 19, fontWeight: 800, marginBottom: 12, flexShrink: 0 }}>🥕 {modalName} 관련 식재료</h3>
