          ...
          {loading ? (
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(2,1fr)', gap:8 }}>
              ...
              <div key={i} style={{ position:'relative' }}>
                ...
                {isAdmin && coupangBadgeInfo(food) && (() => {
                  const b = coupangBadgeInfo(food)
                  return (
                    <div title={b.title}
                      style={{ position:'absolute', top:-7, left:-7, zIndex:5, width:24, height:24,
                        borderRadius:'50%', border:`1.5px solid ${b.color}`, background:b.bg, color:b.color,
                        fontSize:12, display:'flex', alignItems:'center', justifyContent:'center',
                        boxShadow:'0 2px 6px rgba(0,0,0,0.15)' }}>{b.emoji}</div>
                  )
                })()}
            ...
            <div className="grid-auto">
              ...
              <div key={i} style={{ position:'relative' }}>
                ...
                {isAdmin && coupangBadgeInfo(food) && (() => {
                  ...
                  return (
                    <div title={b.title}
                      style={{ position:'absolute', top:-8, left:-8, zIndex:5, width:26, height:26,
                        borderRadius:'50%', border:`1.5px solid ${b.color}`, background:b.bg, color:b.color,
                        fontSize:13, display:'flex', alignItems:'center', justifyContent:'center',
                        boxShadow:'0 2px 6px rgba(0,0,0,0.15)' }}>{b.emoji}</div>
                  )
